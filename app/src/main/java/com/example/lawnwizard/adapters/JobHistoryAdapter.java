...
public class JobHistoryAdapter extends RecyclerView.Adapter<JobHistoryAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        holder.getBinding().userName.setText(jobs.get(position).getHomeowner().getName());
        holder.getBinding().userDistance.setText(fromGeoPoint(holder.itemView.getContext(), jobs.get(position).getLocation())); // context might be wrong
